...
Proxy ->> Client:
  R 0   Here Auth will be checked and if valid, open connection to backend which directly replies to real client AuthenticationOK and takes over the connection
